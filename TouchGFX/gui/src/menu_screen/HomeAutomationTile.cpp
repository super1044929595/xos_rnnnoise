    ...
    numberOfRooms(0)
{
    ...
    roomNameY = 2;
    roomName.setColor(Color::getColorFromRGB(0xFF, 0xFF, 0xFF));
    roomName.setPosition(10, roomNameY, 160, 40);
    roomNameDropShadow.setColor(Color::getColorFromRGB(0x0A, 0x90, 0x0B));
    ...
    temperatureY = 3;
    temperature.setColor(Color::getColorFromRGB(0xFF, 0xFF, 0xFF));
    temperature.setTypedText(TypedText(T_TEMPERATUREINDICATORTILE));
    temperature.setPosition(122, temperatureY, 70, 35);
    Unicode::snprintf(temperatureBuffer, 4, "%d", 0);
    temperature.setWildcard(temperatureBuffer);

    temperatureDropShadow.setColor(Color::getColorFromRGB(0x0A, 0x90, 0x0B));
    ...
    tileId.setPosition(10, getHeight() - 17, 100, 15);
