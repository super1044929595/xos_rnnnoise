...
void TemperatureScheduleMenuItem::setSelected(bool sel)
{
    ...
    if (selected)
    {
        ...
        weekdayText.setColor(Color::getColorFromRGB(0xFF, 0xFF, 0xFF));
        dayTemperature.setColor(Color::getColorFromRGB(0xFF, 0xFF, 0xFF));
        nightTemperature.setColor(Color::getColorFromRGB(0xFF, 0xFF, 0xFF));
    ...
    {
        background.setBitmap(Bitmap(BITMAP_TEMPERATURE_SCHEDULE_MENU_ITEM_ID));
        weekdayText.setColor(Color::getColorFromRGB(0xA9, 0xAD, 0xB6));
        dayTemperature.setColor(Color::getColorFromRGB(0xA9, 0xAD, 0xB6));
        nightTemperature.setColor(Color::getColorFromRGB(0xA9, 0xAD, 0xB6));
        daySelected.setVisible(false);
        nightSelected.setVisible(false);
